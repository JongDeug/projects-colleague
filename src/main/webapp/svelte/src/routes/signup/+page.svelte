...
<Layout>
	<div class="p-8 border w-[60%] m-auto shadow-lg">
		...
		<LoginBtn style="bg-[#3b5998] hover:bg-[#3b5998]/90 mb-3" content="페이스북으로 시작하기" svgName="페이스북" />
		<LoginBtn style="bg-[#24292F] hover:bg-[#24292F]/90 mb-3" content="깃허브로 시작하기" svgName="깃허브" />
		<LoginBtn style="bg-[#4285F4] hover:bg-[#4285F4]/90 mb-3" content="구글로 시작하기" svgName="구글" />
