...
export default abstract class Player {
	...
	abstract createCurrentPlayer(sceneItems)
	abstract createOtherPlayer(sceneItems)
	...
	syncOtherPlayer() {
		for (const sessionId in this.playerEntities) {
			...
			const { serverX, serverY, serverLeft, serverRight, serverUp, serverDown, serverImg } =
	...
	public removeAnims(numberStr) {
		this.scene.anims.remove('down' + numberStr);
		this.scene.anims.remove('up' + numberStr);
		this.scene.anims.remove('right' + numberStr);
		this.scene.anims.remove('left' + numberStr);
	}
