...
function CommentNotice(props){
    ...
    return(
        <>
        {visible&&<div class="list-group-item">
            <div class="row g-0 align-items-center">
                <div class="col-10">
                    <Link to={{pathname:`/post/${postType}/${postId}`, state:{postBoard:postType, postId:postId}}} class="text-dark">
                        <strong>{props.comment.userId}</strong>님이 회원님의 게시글 "{title}"에 댓글을 작성했습니다.
                    </Link>
